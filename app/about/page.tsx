  ...
  return (
    <div className="crawl-wrapper">
      <div className="crawl">
        ...
        <p>In the far reaches of the web galaxy, the developer Arthur embarks on a bold mission to create a system powered by intelligent agents.</p>
        ...
        <p>With voice input functionality and real-time responses, the system blends speech, sound, and personality, allowing users learn as if in a Jedi council.</p>
